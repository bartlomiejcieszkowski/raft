...
namespace Gafa.FileSystem
{
	...
	//		var treeEntry = GetTreeEntry(ref fileName, tree);
	//		if (null == treeEntry)
	//		{
	//			return NtStatus.Error;
	//		}
	...
	//		fileInfo.FileName = fileName.Dequeue();
	...
	//	private TreeEntry GetTreeEntry(string fileName, params object[] args)
	//	{
	...
	//		{
	//			var descendPath = fileName.Dequeue();
	...
	//			return handler.GetFileInformation(ref fileName, ref fileInfo, info, currentBranch.Tip.Tree, currentBranch.Tip);
	//		}
	...
	//		var status = handler.ReadFile(ref fileName, buffer, ref bytesRead, offset, info, currentBranch.Tip.Tree, currentBranch.Tip);
	//		Log.Log(Default, LogExit);
	//		return status;
	//	}
	...
	//		SubFolderHandler handler;
	//		//if (!m_Handlers.TryGetValue(fileName.Peek(), out handler))
	//		//{
	//		if (!m_Handlers.TryGetValue("*", out handler))
	//		{
	//			return NtStatus.Error;
	//		}
	//		//}
	//		var status = handler.FindFiles(ref fileName, ref files, info, currentBranch.Tip.Tree, currentBranch.Tip);
	//		Log.Log(Default, LogExit);
	//		return status;
	//	}
	//}
	...
	//			return handler.FindFiles(ref fileName, ref files, info, args[0]);
	//		}
	...
	//			return handler.FindFiles(ref fileName, ref files, info, currentCommit.Tree, currentCommit);
	//		}
